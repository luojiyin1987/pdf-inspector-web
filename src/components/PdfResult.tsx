    ...
    <section className="result" aria-live="polite">
      ...
      {needsOcr && (
        <div className="notice notice--warning">
          ...
          <p>
            pdf-inspector does not run OCR. Pages needing OCR: {result.pagesNeedingOcr.join(', ')}.
          </p>
        </div>
      )}
        ...
        <article className="detail-card">
          ...
          <small>
            {result.layout.pagesWithTables.length
              ? `Pages ${result.layout.pagesWithTables.join(', ')}`
        ...
        <article className="detail-card">
          ...
          <small>
            {result.layout.pagesWithColumns.length
              ? `Pages ${result.layout.pagesWithColumns.join(', ')}`
      ...
      <div className="markdown-panel">
        ...
        {markdown ? (
          <pre className="markdown-output"><code>{markdown}</code></pre>
        ) : (
